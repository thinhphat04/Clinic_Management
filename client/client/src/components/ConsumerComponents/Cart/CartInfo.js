...
const CartInfo = () => {
  ...
  const handleCheckDefaultInfo = () => {
    const checkboxDefaultInfo = document.querySelector(
      '.cart-info__input-default-info',
    );
  ...
  const handleCheckMethodReceiveAtStore = (e) => {
    ...
    const listDescribe = document.querySelectorAll(
      '.cart-info__input-radio-describe',
    );
    if (e.target.checked) {
      inputElement[3].classList.add('cart-info__input--disabled');
      inputElement[3].disabled = true;
      listDescribe[3].classList.add(
  ...
  const handleCheckMethodReceiveAtAddress = (e) => {
    ...
    if (e.target.checked) {
      ...
      listDescribe[3].classList.remove(
        'cart-info__input-radio-describe--disabled',
      );
  ...
  const handleCheckDefaultAddress = () => {
    const checkboxDefaultAddress = document.querySelector(
      '.cart-info__input-default-address',
    );
    const inputElement = document.querySelectorAll('.cart-info__input');
              ...
              <div className="cart-info__group">
                ...
                <div className="cart-info__input-radio-container">
                  <input
                    name="info-default"
                    type="checkbox"
                    className="cart-info__input-radio cart-info__input-default-info"
                    onClick={handleCheckDefaultInfo}
                  ></input>
                  <label
              ...
              <div className="cart-info__group">
                ...
                <div className="cart-info__input-radio-container">
                  <input
                    name="info-default"
                    type="checkbox"
                    className="cart-info__input-radio cart-info__input-default-address"
